...
export declare class En3SourceManager<T> extends SourceManager {
     ...
     * Resource store.
     */
    get data(): Store<T | null | undefined, keyof import('../../store').StoreManagers, import('../../store').StoreEntry<T | null | undefined>>;
    /**
     * Loading store.
     */
    get loading(): Store<En3SourceManagerLoadingState, keyof import('../../store').StoreManagers, import('../../store').StoreEntry<En3SourceManagerLoadingState>>;
    /**
